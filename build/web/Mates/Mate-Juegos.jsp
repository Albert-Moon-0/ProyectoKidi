...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url('data:image/svg+xml;utf8,<svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><text x="10" y="30" font-family="Arial" font-size="10" fill="%234FC1E9" opacity="0.3">A</text><text x="40" y="50" font-family="Arial" font-size="12" fill="%23FF5757" opacity="0.3">B</text><text x="70" y="25" font-family="Arial" font-size="14" fill="%23A0E57D" opacity="0.3">C</text><text x="20" y="80" font-family="Arial" font-size="11" fill="%23C990FF" opacity="0.3">Z</text></svg>');
...
<body>
    ...
    <footer class="py-3 mt-5">
        <div class="container">
            ...
            <p class="text-center">© 2024 KIDI, Inc ¡Aprender inglés es divertido!</p>
        </div>
    </footer>
