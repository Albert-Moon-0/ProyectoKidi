<%-- 
    Document   : 403
    Created on : 27 jun 2025, 14:09:35
    Author     : diego
--%>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            No tienes permisos para acceder a este recurso. Es posible que necesites 
            iniciar sesión o que no tengas los privilegios necesarios para ver esta página.
        </p>
        ...
        <div class="error-details">
            ...
            <strong>Código de error:</strong> 403 - Forbidden<br>
