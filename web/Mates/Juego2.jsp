...
<html lang="es">
    <head>
        ...
        <title>Operaciones Matemáticas Rápidas</title>
    ...
    <body>
        <h1>¡Operaciones Matemáticas Rápidas!</h1>
        <button class="back-btn" onclick="window.history.back()">&larr;</button>

        <div class="game-container">
            <p class="game-instructions">Resuelve las operaciones matemáticas lo más rápido posible. ¡Cada respuesta correcta suma puntos y tiempo extra!</p>

            <div class="difficulty-selector" id="difficultySelector">
                <p>Selecciona la dificultad:</p>
                <button onclick="setDifficulty('easy')" class="difficulty-btn easy-btn active-difficulty">Fácil</button>
                <button onclick="setDifficulty('medium')" class="difficulty-btn medium-btn">Medio</button>
                <button onclick="setDifficulty('hard')" class="difficulty-btn hard-btn">Difícil</button>
            </div>

            <div class="operation-type-selector" id="operationTypeSelector">
                <p>Selecciona el tipo de operación:</p>
                ...
                <button onclick="setOperationType('multiplication')" class="type-btn multiplication-btn">Multiplicación</button>
                <button onclick="setOperationType('division')" class="type-btn division-btn">División</button>
            ...
            <div id="gameOverArea" class="hide">
                ...
                <div class="results-container" id="resultsContainer">
                    ...
                    <p class="results-stat">Precisión: <span id="accuracy"></span>%</p>
    ...
    // Funciones para establecer dificultad y tipo de operación
...
function generateOperation() {
    ...
    // Ajustar rango de números según nivel y dificultad
    let maxNum;
    switch(difficulty) {
        case 'easy':
            maxNum = 10 + (level * 2);
    ...
    function checkAnswer() {
        ...
        if (userAnswer === currentAnswer) {
            ...
            if (correctCount % 5 === 0) {
                ...
                // Añadir tiempo bonus por subir de nivel
                timeLeft += 5;
                updateTimerDisplay();
    ...
    function endGame() {
        ...
        let feedback = '';
        if (level >= 5) {
            feedback = '¡Excelente dominio matemático! Tienes habilidades impresionantes.';
        } else if (level >= 3) {
            feedback = '¡Muy bien! Estás mostrando buenas habilidades matemáticas.';
        } else {
            feedback = 'Sigue practicando. ¡La práctica hace al maestro!';
        }
    ...
    // Crear animación de número volador
