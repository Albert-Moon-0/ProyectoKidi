        ...
        <main class="container my-5">
            ...
            <section class="card p-4 mb-4">
                ...
                <div class="d-flex flex-wrap justify-content-around">
                    <div class="time-card">
                        <img src="../Imagenes/reloj_3.png" alt="Reloj marcando las 3 en punto" class="img-fluid coin-image">
                        <p class="time-example">3:00</p>
                        <p>Las tres en punto</p>
                    </div>
                    <div class="time-card">
                        <img src="../Imagenes/reloj_530.png" alt="Reloj marcando las 5 y media" class="img-fluid coin-image">
                        <p class="time-example">5:30</p>
                        <p>Las cinco y media</p>
                    </div>
                    <div class="time-card">
                        <img src="../Imagenes/reloj_945.png" alt="Reloj marcando las 9:45" class="img-fluid coin-image">
            ...
            <section class="card p-4 mb-4">
                ...
                <div class="d-flex flex-wrap justify-content-around">
                    <div class="money-card">
                        <img src="../Imagenes/moneda_1peso.png" alt="Moneda de 1 peso" class="img-fluid coin-image">
                        <p class="money-example">1 peso</p>
                        <p>La moneda más pequeña</p>
                    </div>
                    <div class="money-card">
                        <img src="../Imagenes/moneda_5peso.png" alt="Moneda de 5 pesos" class="img-fluid coin-image">
                        <p class="money-example">5 pesos</p>
                        <p>Vale 5 monedas de 1 peso</p>
                    </div>
                    <div class="money-card">
                        <img src="../Imagenes/moneda_10peso.png" alt="Moneda de 10 pesos" class="img-fluid coin-image">
                        <p class="money-example">10 pesos</p>
                        <p>Vale 10 monedas de 1 peso</p>
                    </div>
                </div>
            </section>
            ...
            <section class="card p-4 mb-4">
                ...
                <p class="mt-3">Por ejemplo, si tenemos 3 monedas de 10 pesos y 9 monedas de 1 peso, tenemos en total $39 pesos.</p>
            </section>
            ...
            <section class="card p-4 mb-4">
                ...
                <div class="mt-4">
                    <div class="practice-item">
                        <p>Si tienes 3 monedas de 1 peso, ¿cuánto dinero tienes? <span class="answer">3 euros</span></p>
                    </div>
                    <div class="practice-item">
                        <p>Si tienes 2 monedas de 5 pesos, ¿cuánto dinero tienes? <span class="answer">1 euro</span></p>
                    </div>
                    <div class="practice-item">
                        <p>Si tienes 1 moneda de 10 pesos y 3 monedas de 5 pesos, ¿cuánto dinero tienes en total? <span class="answer">2,40 euros</span></p>
                    </div>
                </div>
            </section>
        </main>
