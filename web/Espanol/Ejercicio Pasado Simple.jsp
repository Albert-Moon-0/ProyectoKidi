    ...
    <script>
        function checkAnswers() {
            ...
            if (correct === totalQuestions) {
                ...
                feedbackDiv.innerHTML = "¡FANTÁSTICO! ? ¡Has completado todas las oraciones correctamente! ¡Eres un/a experto/a en el pasado simple!";
            } else {
                feedbackDiv.className = "feedback incorrect";
                feedbackDiv.innerHTML = `¡Has acertado ${correct} de ${totalQuestions}! ? ¡Sigue practicando y pronto dominarás el pasado simple!`;
            }
        }
    </script>
