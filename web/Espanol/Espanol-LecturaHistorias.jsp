...
<html lang="es">
    <head>
        ...
        <title>Lecturas Infantiles</title>
    ...
    <body>
        ...
        <div class="page-container">
            <h1>Lecturas Infantiles</h1>
            
            <center>
                <a href="P-Espanol.jsp">
            ...
            <div class="grid">
                <div class="card card-theme-blue">
                    <a href="EspanolLectura1.jsp">
                        <img src="../img/lec1.jpg" alt="El patito feo">
                        <div class="card-content">
                            <h3>El patito feo</h3>
                            <p>Conoce la historia del patito que era diferente y descubre cómo encontró su verdadera identidad.</p>
                            <span class="read-more">Leer historia</span>
                        </div>
                    </a>
                </div>
                
                <div class="card card-theme-purple">
                    <a href="EspanolLectura2.jsp">
                        <img src="../img/lec2.png" alt="La bella durmiente">
                        <div class="card-content">
                            <h3>La bella durmiente</h3>
                            <p>Sumérgete en la mágica historia de una princesa y el hechizo que la sumió en un profundo sueño.</p>
                            <span class="read-more">Leer historia</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="card card-theme-orange">
                    <a href="EspanolLectura3.jsp">
                        <img src="../img/lec3.jpg" alt="Ricitos de oro y los 3 osos">
                        <div class="card-content">
                            <h3>Ricitos de oro</h3>
                            <p>Acompaña a Ricitos de oro en su aventura cuando descubre la casa de los tres osos en el bosque.</p>
                            <span class="read-more">Leer historia</span>
                        </div>
                    </a>
                </div>
                ...
                <div class="card card-theme-pink">
                    <a href="EspanolLectura4.jsp">
                        <img src="../img/lec4.jpg" alt="Los 3 cerditos">
                        <div class="card-content">
                            <h3>Los 3 cerditos</h3>
                            <p>Descubre la importante lección que aprenden tres hermanos cerditos sobre el trabajo y la perseverancia.</p>
                            <span class="read-more">Leer historia</span>
                        </div>
                    </a>
                </div>
            ...
            <footer>
                ...
                <p>
                    <i class="fas fa-book"></i> ¡Explora nuestras historias y diviértete leyendo! <i class="fas fa-star"></i>
                </p>
            </footer>
        </div>
    </body>
